...
import com.iv.outer.dto.GroupUsersEntityDto;
...
public interface IGroupService {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/select/curUserGroups", method = RequestMethod.GET)
	ResponseDto selectCurUserGroups();
	...
	GroupUsersEntityDto groupUserPageInfo(@RequestBody GroupQuery groupQuery);
