...
Source Server         : 10.10.31.25
Source Server Version : 50505
Source Host           : 10.10.31.25:3306
Source Database       : form_service

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2018-06-25 15:23:40
*/
...
CREATE TABLE IF NOT EXISTS `form_change_logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='工单流转记录表';
...
CREATE TABLE IF NOT EXISTS `form_client` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKq0x9rdjhjfauuyglwqxyphqh1` (`company_id`),
  CONSTRAINT `FKq0x9rdjhjfauuyglwqxyphqh1` FOREIGN KEY (`company_id`) REFERENCES `form_company` (`id`)
...
CREATE TABLE IF NOT EXISTS `form_marks` (
  ...
  `create_date` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='标星';
...
CREATE TABLE IF NOT EXISTS `form_operate_logs` (
  ...
  `second_demand_type_code` int(11) DEFAULT NULL,
