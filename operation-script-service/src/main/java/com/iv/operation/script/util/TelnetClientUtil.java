...
public class TelnetClientUtil {
     ...
     *            - 密码
     */
    public  TelnetClientUtil(String hostname, String username, String password) {
     ...
     *            - 密码
     */
    public TelnetClientUtil(String hostname, int port, String username, String password) {
        this.hostname = hostname;
        this.port = port;
        this.username = username;
        this.password = password;
